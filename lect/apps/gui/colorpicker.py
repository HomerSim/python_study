...
class MyPicker(QtWidgets.QMainWindow):
    ...
    def updateWindow(self, pt):
        ...
        if self.saveBGR[0][0] >= 0 and self.saveBGR[1][0] >= 0:
            ...
            nB = self.saveBGR[0][2] + int((self.saveBGR[1][0] - self.saveBGR[0][0] / 2) * 1) 
            out_mix, text_color_mix, bg_color_mix = self.get_code((nR,nG,nB))
    ...
    def createWidgets(self):
        ...
        self.viewer.setAlignment(QtCore.Qt.AlignCenter|QtCore.Qt.AlignCenter)
