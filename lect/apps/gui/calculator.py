...
from PyQt5.QtWidgets import QMainWindow, QApplication, QToolButton, QSizePolicy, QLineEdit, QWidget, QGridLayout, QLayout, QVBoxLayout
...
class MyCalculator(QWidget):
    def __init__(self):
        ...
        self.mulButton = self.createButton("*", self.clickButtons)
        ...
        gridLayout.addWidget(self.mulButton, 1, 3, 1, 1)
    ...
    def string_calculator(self, user_input, shopw_history = False):
